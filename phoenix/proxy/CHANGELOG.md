...
[unreleased]: https://github.com/owncloud/mono/proxy/compare/v0.7.0...master

## Summary

* Bugfix - Fix director selection: [#99](https://github.com/owncloud/mono/proxy/pull/99)
* Bugfix - Add settings API and app endpoints to example config: [#93](https://github.com/owncloud/mono/proxy/pull/93)
* Change - Remove accounts caching: [#100](https://github.com/owncloud/mono/proxy/pull/100)
* Enhancement - Add hello API and app endpoints to example config and builtin config: [#96](https://github.com/owncloud/mono/proxy/pull/96)
* Enhancement - Add roleIDs to the access token: [#95](https://github.com/owncloud/mono/proxy/pull/95)
...
[0.7.0]: https://github.com/owncloud/mono/proxy/compare/v0.6.0...v0.7.0

## Summary

* Enhancement - Add numeric uid and gid to the access token: [#89](https://github.com/owncloud/mono/proxy/pull/89)
* Enhancement - Add configuration options for the pre-signed url middleware: [#91](https://github.com/owncloud/mono/proxy/issues/91)
...
[0.6.0]: https://github.com/owncloud/mono/proxy/compare/v0.5.0...v0.6.0

## Summary

* Bugfix - Enable new accounts by default: [#79](https://github.com/owncloud/mono/proxy/pull/79)
* Bugfix - Lookup user by id for presigned URLs: [#85](https://github.com/owncloud/mono/proxy/pull/85)
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#78](https://github.com/owncloud/mono/proxy/pull/78)
* Change - Add settings and ocs group routes: [#81](https://github.com/owncloud/mono/proxy/pull/81)
* Change - Add route for user provisioning API in ocis-ocs: [#80](https://github.com/owncloud/mono/proxy/pull/80)
...
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#78](https://github.com/owncloud/mono/proxy/pull/78)
   ...
   https://github.com/owncloud/mono/proxy/pull/78
...
* Change - Add settings and ocs group routes: [#81](https://github.com/owncloud/mono/proxy/pull/81)
   ...
   https://github.com/owncloud/mono/proxy/pull/81
...
[0.5.0]: https://github.com/owncloud/mono/proxy/compare/v0.4.0...v0.5.0

## Summary

* Bugfix - Provide token configuration from config: [#69](https://github.com/owncloud/mono/proxy/pull/69)
* Bugfix - Provide token configuration from config: [#76](https://github.com/owncloud/mono/proxy/pull/76)
* Change - Add OIDC config flags: [#66](https://github.com/owncloud/mono/proxy/pull/66)
* Change - Mint new username property in the reva token: [#62](https://github.com/owncloud/mono/proxy/pull/62)
* Enhancement - Add Accounts UI routes: [#65](https://github.com/owncloud/mono/proxy/pull/65)
* Enhancement - Add option to disable TLS: [#71](https://github.com/owncloud/mono/proxy/issues/71)
* Enhancement - Only send create home request if an account has been migrated: [#52](https://github.com/owncloud/mono/proxy/issues/52)
* Enhancement - Create a root span on proxy that propagates down to consumers: [#64](https://github.com/owncloud/mono/proxy/pull/64)
* Enhancement - Support signed URLs: [#73](https://github.com/owncloud/mono/proxy/issues/73)
...
[0.4.0]: https://github.com/owncloud/mono/proxy/compare/v0.3.1...v0.4.0

## Summary

* Bugfix - Accounts service response was ignored: [#43](https://github.com/owncloud/mono/proxy/pull/43)
* Bugfix - Fix x-access-token in header: [#41](https://github.com/owncloud/mono/proxy/pull/41)
* Change - Point /data endpoint to reva frontend: [#45](https://github.com/owncloud/mono/proxy/pull/45)
* Change - Send autocreate home request to reva gateway: [#51](https://github.com/owncloud/mono/proxy/pull/51)
* Change - Update to new accounts API: [#39](https://github.com/owncloud/mono/proxy/issues/39)
* Enhancement - Retrieve Account UUID From User Claims: [#36](https://github.com/owncloud/mono/proxy/pull/36)
* Enhancement - Create account if it doesn't exist in ocis-accounts: [#55](https://github.com/owncloud/mono/proxy/issues/55)
* Enhancement - Disable keep-alive on server-side OIDC requests: [#268](https://github.com/owncloud/ocis/issues/268)
* Enhancement - Make jwt secret configurable: [#41](https://github.com/owncloud/mono/proxy/pull/41)
* Enhancement - Respect account_enabled flag: [#53](https://github.com/owncloud/mono/proxy/issues/53)
...
* Bugfix - Accounts service response was ignored: [#43](https://github.com/owncloud/mono/proxy/pull/43)
   ...
   https://github.com/owncloud/mono/proxy/pull/43
...
* Bugfix - Fix x-access-token in header: [#41](https://github.com/owncloud/mono/proxy/pull/41)
   ...
   https://github.com/owncloud/mono/proxy/pull/41
   https://github.com/owncloud/mono/proxy/pull/46
...
* Change - Point /data endpoint to reva frontend: [#45](https://github.com/owncloud/mono/proxy/pull/45)
   ...
   https://github.com/owncloud/mono/proxy/pull/45
...
* Change - Send autocreate home request to reva gateway: [#51](https://github.com/owncloud/mono/proxy/pull/51)
   ...
   https://github.com/owncloud/mono/proxy/pull/51
...
* Change - Update to new accounts API: [#39](https://github.com/owncloud/mono/proxy/issues/39)
   ...
   https://github.com/owncloud/mono/proxy/issues/39
...
* Enhancement - Retrieve Account UUID From User Claims: [#36](https://github.com/owncloud/mono/proxy/pull/36)
   ...
   https://github.com/owncloud/mono/proxy/pull/36
...
* Enhancement - Disable keep-alive on server-side OIDC requests: [#268](https://github.com/owncloud/ocis/issues/268)
   ...
   https://github.com/owncloud/mono/proxy/pull/42
...
[0.3.1]: https://github.com/owncloud/mono/proxy/compare/v0.3.0...v0.3.1

## Summary

* Change - Update ocis-pkg: [#30](https://github.com/owncloud/mono/proxy/pull/30)
...
* Change - Update ocis-pkg: [#30](https://github.com/owncloud/mono/proxy/pull/30)
   ...
   https://github.com/owncloud/mono/proxy/pull/30

# Changelog for [0.3.0] (2020-03-30)

The following sections list the changes for ocis-proxy 0.3.0.

[0.3.0]: https://github.com/owncloud/mono/proxy/compare/v0.2.1...v0.3.0

## Summary

* Change - Insecure http-requests are now redirected to https: [#29](https://github.com/owncloud/mono/proxy/pull/29)
* Enhancement - Configurable OpenID Connect client: [#27](https://github.com/owncloud/mono/proxy/pull/27)
* Enhancement - Add policy selectors: [#4](https://github.com/owncloud/mono/proxy/issues/4)
...
[0.2.1]: https://github.com/owncloud/mono/proxy/compare/v0.2.0...v0.2.1

## Summary

* Bugfix - Set TLS-Certificate correctly: [#25](https://github.com/owncloud/mono/proxy/pull/25)
...
[0.2.0]: https://github.com/owncloud/mono/proxy/compare/v0.1.0...v0.2.0

## Summary

* Change - Route requests based on regex or query parameters: [#21](https://github.com/owncloud/mono/proxy/issues/21)
* Enhancement - Proxy client urls in default configuration: [#19](https://github.com/owncloud/mono/proxy/issues/19)
* Enhancement - Make TLS-Cert configurable: [#14](https://github.com/owncloud/mono/proxy/pull/14)
...
[0.1.0]: https://github.com/owncloud/mono/proxy/compare/500e303cb544ed93d84153f01219d77eeee44929...v0.1.0

## Summary

* Change - Initial release of basic version: [#1](https://github.com/owncloud/mono/proxy/issues/1)
* Enhancement - Load Proxy Policies at Runtime: [#17](https://github.com/owncloud/mono/proxy/issues/17)
...
* Change - Initial release of basic version: [#1](https://github.com/owncloud/mono/proxy/issues/1)
   ...
   https://github.com/owncloud/mono/proxy/issues/1
