...
[unreleased]: https://github.com/owncloud/mono/phoenix/compare/v0.13.0...master
...
* Bugfix - Fix external app URLs: [#218](https://github.com/owncloud/product/issues/218)
   ...
   https://github.com/owncloud/mono/phoenix/pull/83

# Changelog for [0.13.0] (2020-08-25)

The following sections list the changes in ocis-phoenix 0.13.0.

[0.13.0]: https://github.com/owncloud/mono/phoenix/compare/v0.12.0...v0.13.0

## Summary

* Change - Update Phoenix: [#81](https://github.com/owncloud/mono/phoenix/pull/81)
...
* Change - Update Phoenix: [#81](https://github.com/owncloud/mono/phoenix/pull/81)
   ...
   https://github.com/owncloud/mono/phoenix/pull/81
...
[0.12.0]: https://github.com/owncloud/mono/phoenix/compare/v0.11.0...v0.12.0

## Summary

* Change - Enable Settings and Accounts apps by default: [#80](https://github.com/owncloud/mono/phoenix/pull/80)
* Change - Update Phoenix: [#79](https://github.com/owncloud/mono/phoenix/pull/79)
...
[0.11.0]: https://github.com/owncloud/mono/phoenix/compare/v0.10.0...v0.11.0

## Summary

* Bugfix - Exit when assets or config are not found: [#76](https://github.com/owncloud/mono/phoenix/pull/76)
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#73](https://github.com/owncloud/mono/phoenix/pull/73)
* Change - Hide searchbar by default: [#116](https://github.com/owncloud/product/issues/116)
* Change - Update Phoenix: [#78](https://github.com/owncloud/mono/phoenix/pull/78)
...
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#73](https://github.com/owncloud/mono/phoenix/pull/73)
   ...
   https://github.com/owncloud/mono/phoenix/pull/73
...
[0.10.0]: https://github.com/owncloud/mono/phoenix/compare/v0.9.0...v0.10.0

## Summary

* Change - Update Phoenix: [#72](https://github.com/owncloud/mono/phoenix/pull/72)
...
* Bugfix - Allow silent refresh of access token: [#69](https://github.com/owncloud/ocis-konnectd/issues/69)
   ...
   https://github.com/owncloud/mono/phoenix/pull/69

* Change - Update Phoenix: [#70](https://github.com/owncloud/mono/phoenix/pull/70)

   Updated phoenix from v0.11.1 to v0.12.0

   https://github.com/owncloud/mono/phoenix/pull/70

# Changelog for [0.8.1] (2020-06-29)

The following sections list the changes in ocis-phoenix 0.8.1.

[0.8.1]: https://github.com/owncloud/mono/phoenix/compare/v0.8.0...v0.8.1

## Summary

* Change - Update Phoenix: [#68](https://github.com/owncloud/mono/phoenix/pull/68)
...
* Change - Update Phoenix: [#68](https://github.com/owncloud/mono/phoenix/pull/68)
   ...
   https://github.com/owncloud/mono/phoenix/pull/68

# Changelog for [0.8.0] (2020-06-26)

The following sections list the changes in ocis-phoenix 0.8.0.

[0.8.0]: https://github.com/owncloud/mono/phoenix/compare/v0.7.0...v0.8.0

## Summary

* Change - Update Phoenix: [#67](https://github.com/owncloud/mono/phoenix/pull/67)
...
* Change - Update Phoenix: [#67](https://github.com/owncloud/mono/phoenix/pull/67)
   ...
   https://github.com/owncloud/mono/phoenix/pull/67

# Changelog for [0.7.0] (2020-05-26)

The following sections list the changes in ocis-phoenix 0.7.0.

[0.7.0]: https://github.com/owncloud/mono/phoenix/compare/v0.6.0...v0.7.0

## Summary

* Change - Update Phoenix: [#66](https://github.com/owncloud/mono/phoenix/pull/66)
...
* Change - Update Phoenix: [#66](https://github.com/owncloud/mono/phoenix/pull/66)
   ...
   https://github.com/owncloud/mono/phoenix/pull/66

# Changelog for [0.6.0] (2020-04-28)

The following sections list the changes in ocis-phoenix 0.6.0.

[0.6.0]: https://github.com/owncloud/mono/phoenix/compare/v0.5.0...v0.6.0

## Summary

* Change - Update Phoenix: [#65](https://github.com/owncloud/mono/phoenix/pull/65)
...
* Change - Update Phoenix: [#65](https://github.com/owncloud/mono/phoenix/pull/65)
   ...
   https://github.com/owncloud/mono/phoenix/pull/65

# Changelog for [0.5.0] (2020-04-14)

The following sections list the changes in ocis-phoenix 0.5.0.

[0.5.0]: https://github.com/owncloud/mono/phoenix/compare/v0.4.1...v0.5.0

## Summary

* Change - Update Phoenix: [#63](https://github.com/owncloud/mono/phoenix/pull/63)
...
* Change - Update Phoenix: [#63](https://github.com/owncloud/mono/phoenix/pull/63)
   ...
   https://github.com/owncloud/mono/phoenix/pull/63

# Changelog for [0.4.1] (2020-04-01)

The following sections list the changes in ocis-phoenix 0.4.1.

[0.4.1]: https://github.com/owncloud/mono/phoenix/compare/v0.4.0...v0.4.1

## Summary

* Bugfix - Create a new tag to fix v0.4.0: [#62](https://github.com/owncloud/mono/phoenix/pull/62)
...
* Bugfix - Create a new tag to fix v0.4.0: [#62](https://github.com/owncloud/mono/phoenix/pull/62)
   ...
   https://github.com/owncloud/mono/phoenix/pull/62

# Changelog for [0.4.0] (2020-03-31)

The following sections list the changes in ocis-phoenix 0.4.0.

[0.4.0]: https://github.com/owncloud/mono/phoenix/compare/v0.2.0...v0.4.0

## Summary

* Change - Update Phoenix: [#60](https://github.com/owncloud/mono/phoenix/pull/60)
* Enhancement - Configuration: [#57](https://github.com/owncloud/mono/phoenix/pull/57)
...
* Change - Update Phoenix: [#60](https://github.com/owncloud/mono/phoenix/pull/60)
   ...
   https://github.com/owncloud/mono/phoenix/pull/60
...
[0.2.0]: https://github.com/owncloud/mono/phoenix/compare/v0.3.0...v0.2.0

## Summary

* Bugfix - Config file value not being read: [#45](https://github.com/owncloud/mono/phoenix/pull/45)
* Enhancement - Update to Phoenix v0.5.0: [#43](https://github.com/owncloud/mono/phoenix/issues/43)
* Enhancement - Update to Phoenix v0.6.0: [#53](https://github.com/owncloud/mono/phoenix/pull/53)
...
* Enhancement - Update to Phoenix v0.6.0: [#53](https://github.com/owncloud/mono/phoenix/pull/53)
   ...
   https://github.com/owncloud/mono/phoenix/pull/53

# Changelog for [0.3.0] (2020-03-17)

The following sections list the changes in ocis-phoenix 0.3.0.

[0.3.0]: https://github.com/owncloud/mono/phoenix/compare/v0.1.0...v0.3.0

## Summary

* Change - Default to running behind ocis-proxy: [#55](https://github.com/owncloud/mono/phoenix/pull/55)
...
[0.1.0]: https://github.com/owncloud/mono/phoenix/compare/432c57c406a8421a20ba596818d95f816e2ef9c7...v0.1.0

## Summary

* Change - Initial release of basic version: [#3](https://github.com/owncloud/mono/phoenix/issues/3)
