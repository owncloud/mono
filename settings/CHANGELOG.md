...
[unreleased]: https://github.com/owncloud/mono/settings/compare/v0.3.1...master

## Summary

* Bugfix - Fix loading and saving system scoped values: [#66](https://github.com/owncloud/mono/settings/pull/66)
* Bugfix - Complete input validation: [#66](https://github.com/owncloud/mono/settings/pull/66)
* Change - Add filter option for bundle ids in ListBundles and ListRoles: [#59](https://github.com/owncloud/mono/settings/pull/59)
* Change - Reuse roleIDs from the metadata context: [#69](https://github.com/owncloud/mono/settings/pull/69)
* Change - Update ocis-pkg/v2: [#72](https://github.com/owncloud/mono/settings/pull/72)
...
[0.3.1]: https://github.com/owncloud/mono/settings/compare/v0.3.0...v0.3.1

## Summary

* Bugfix - Fix fetching bundles in settings UI: [#61](https://github.com/owncloud/mono/settings/pull/61)
...
[0.3.0]: https://github.com/owncloud/mono/settings/compare/v0.2.0...v0.3.0
...
[0.2.0]: https://github.com/owncloud/mono/settings/compare/v0.1.0...v0.2.0

## Summary

* Change - Add role service: [#110](https://github.com/owncloud/product/issues/110)
* Change - Rename endpoints and message types: [#36](https://github.com/owncloud/mono/settings/issues/36)
* Change - Use UUIDs instead of alphanumeric identifiers: [#46](https://github.com/owncloud/mono/settings/pull/46)
...
[0.1.0]: https://github.com/owncloud/mono/settings/compare/6fdbbd7e8eb39f18ada1a8a3c45a1c925e239889...v0.1.0

## Summary

* Bugfix - Adjust UUID validation to be more tolerant: [#41](https://github.com/owncloud/mono/settings/issues/41)
* Bugfix - Fix runtime error when type asserting on nil value: [#38](https://github.com/owncloud/mono/settings/pull/38)
...
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#39](https://github.com/owncloud/mono/settings/pull/39)
* Change - Dynamically add navItems for extensions with settings bundles: [#25](https://github.com/owncloud/mono/settings/pull/25)
* Change - Introduce input validation: [#22](https://github.com/owncloud/mono/settings/pull/22)
* Change - Use account uuid from x-access-token: [#14](https://github.com/owncloud/mono/settings/pull/14)
* Change - Use server config variable from ocis-web: [#34](https://github.com/owncloud/mono/settings/pull/34)
* Enhancement - Remove paths from Makefile: [#33](https://github.com/owncloud/mono/settings/pull/33)
* Enhancement - Extend the docs: [#11](https://github.com/owncloud/mono/settings/issues/11)
* Enhancement - Update ocis-pkg/v2: [#42](https://github.com/owncloud/mono/settings/pull/42)
...
* Bugfix - Adjust UUID validation to be more tolerant: [#41](https://github.com/owncloud/mono/settings/issues/41)
   ...
   https://github.com/owncloud/mono/settings/issues/41
...
* Bugfix - Build docker images with alpine:latest instead of alpine:edge: [#39](https://github.com/owncloud/mono/settings/pull/39)
   ...
   https://github.com/owncloud/mono/settings/pull/39
